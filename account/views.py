...
class LoginView(ObtainAuthToken):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({
            ...
            'email': user.email,
            'languages_tr': user.languages[1][0],
            'languages_az': user.languages[2][0],
            'languages_uz': user.languages[3][0],
            'languages_kk': user.languages[4][0],
            'languages_ug': user.languages[5][0],
            'languages_tk': user.languages[6][0],
            'languages_tt': user.languages[7][0],
            'languages_ky': user.languages[8][0],
            'languages_ksk': user.languages[9][0],
            'languages_ba': user.languages[10][0],
            'languages_cv': user.languages[11][0],
            'languages_ash': user.languages[12][0],
            'languages_kaa': user.languages[13][0],
            'languages_krc': user.languages[14][0],
            'languages_sah': user.languages[15][0],
            'languages_ctt': user.languages[16][0],
            'languages_alt': user.languages[17][0],
        })
